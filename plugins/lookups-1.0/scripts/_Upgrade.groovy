...
// Ant.mkdir(dir:"C:\Users\Paul\Documents\NetBeansProjects/lookups/grails-app/jobs")
//

Ant.property(environment:"env")
grailsHome = Ant.antProject.properties."env.GRAILS_HOME"
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookups.properties",
         todir:"${basedir}/grails-app/i18n")
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/lookupValues.properties",
         todir:"${basedir}/grails-app/i18n")
