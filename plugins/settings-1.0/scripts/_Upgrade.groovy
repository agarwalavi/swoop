...
// Ant.mkdir(dir:"C:\Users\Paul\Documents\NetBeansProjects/settings/grails-app/jobs")
//

Ant.property(environment:"env")
grailsHome = Ant.antProject.properties."env.GRAILS_HOME"
Ant.copy(file:"${pluginBasedir}/grails-app/i18n/settings.properties", todir:"${basedir}/grails-app/i18n")
