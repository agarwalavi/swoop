 ...
 */
class MaintenanceSchedule extends BaseDomain implements Serializable
{
  static constraints =
  {}
  static hasMany = [scheduleItems: MaintenanceScheduleItem]
  String assemblyType
  String vehicleType
  String fuelType
  String description
  BigDecimal maintenanceInterval
  String maintenanceIntervalType
  String make
  String model
  String name
}
