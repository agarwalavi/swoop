...
<html>
    <head>
        ...
        <title>Edit ServiceRequest</title>
    </head>
    <body>
        <div class="nav">
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="maintenances">Maintenances:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:serviceRequestInstance,field:'maintenances','errors')}">
...
<g:link controller="maintenance" params="['serviceRequest.id':serviceRequestInstance?.id]" action="create">Add Maintenance</g:link>
