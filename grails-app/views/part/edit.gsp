                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:partInstance,field:'vendorParts','errors')}">
...
<g:link controller="vendorPart" params="['part.id':partInstance?.id]" action="create">Add VendorPart</g:link>
