...
<html>
    <head>
        ...
        <title>Edit VehicleReport</title>
    </head>
    <body>
        <div class="nav">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:vehicleReportInstance,field:'items','errors')}">
...
<g:link controller="vehicleReportItem" params="['vehicleReport.id':vehicleReportInstance?.id]" action="create">Add VehicleReportItem</g:link>
