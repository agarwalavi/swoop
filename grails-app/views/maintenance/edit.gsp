                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:maintenanceInstance,field:'items','errors')}">
...
<g:link controller="maintenanceItem" params="['maintenance.id':maintenanceInstance?.id]" action="create">Add MaintenanceItem</g:link>
